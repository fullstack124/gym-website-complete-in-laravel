...
<head>
    ...
    <title>@yield('title') | Fit2Go</title>
    ...
    <link type="text/css" href="{{ asset('vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('vendors/bootstrapvalidator/dist/css/bootstrapValidator.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('vendors/datatables/css/dataTables.bootstrap.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('vendors/fancyBox/source/jquery.fancybox.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('vendors/jquery-circliful/css/jquery.circliful.css') }}" rel="stylesheet">
    <link type="text/css" href="{{ asset('vendors/summernote/summernote.css') }}" rel="stylesheet">
    ...
    <link type="text/css" href="{{ asset('css/custom_css/timings.css') }}" rel="stylesheet" />
    <link type="text/css" href="{{ asset('css/custom_css/coupon.css') }}" rel="stylesheet" />
...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle padding-user" data-toggle="dropdown">
                            <img src="img/authors/avatar1.jpg" width="35"
                    ...
                    <div class="nav_profile">
                        <div class="media profile-left">
                            <a class="pull-left profile-thumb" href="#">
                                <img src="{{ asset('img/authors/avatar1.jpg') }}" class="img-circle"
                                    alt="User Image">
                            </a>
    ...
    <script src="{{ asset('vendors/summernote/summernote.min.js')}}" type="text/javascript"></script>
    <script src="{{ asset('vendors/jasny-bootstrap/js/jasny-bootstrap.js')}}" type="text/javascript"></script>
    <script src="{{ asset('vendors/moment/moment.js')}}" type="text/javascript"></script>
    <script src="{{ asset('vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js')}}" type="text/javascript"></script>
    <script src="{{ asset('vendors/bootstrapvalidator/dist/js/bootstrapValidator.js')}}" type="text/javascript"></script>
    <script src="{{ asset('vendors/fancyBox/source/jquery.fancybox.js')}}" type="text/javascript"></script>
    <script src="{{ asset('vendors/datatables/js/jquery.dataTables.min.js')}}" type="text/javascript"></script>
    <script src="{{ asset('vendors/datatables/js/dataTables.bootstrap.js')}}" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="{{ asset('vendors/jquery-easy-ticker-master/jquery.easy-ticker.min.js') }}">
    </script>
