...
<head>
    ...
    <!-- end of global css -->
    <!--page level css -->
    <link type="text/css" href="{{ asset('vendors/summernote/summernote.css')}}" rel="stylesheet" media="screen" />
    ...
    <link type="text/css" href="{{ asset('vendors/fancyBox/source/jquery.fancybox.css')}}" media="screen" rel="stylesheet" />
...
<body>
    ...
    <script src="{{ asset('vendors/fancyBox/source/jquery.fancybox.js') }}?v=2.1.5" type="text/javascript"></script>
    ...
    <script src="{{ asset('js/custom_js/packages.js') }}" type="text/javascript"></script>
