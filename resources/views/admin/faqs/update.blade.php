    ...
    <aside class="right-side right-padding">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="add_faq.html" class="activated">Update Faq</a>
                </li>
            </ol>
        </section>
        <!--section ends-->
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <i class="fa fa-fw fa-question-circle"></i> Update Faq
                            </h4>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="add_faq_for" action="{{ route('admin.faq.update', ['id' => $faq->id]) }}"
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="{{ $faq->title }}" name="title"
                                                        id="title" class="form-control text1" placeholder="Enter Title">
                                                </div>
                                                @error('title')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <textarea name="content" class="summernote edi-css form-control">{{ $faq->description }}</textarea>
                                            </div>
                                            @error('content')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
