                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="packages" method="POST" action="{{ route('admin.add.package') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="package_name" id="title"
                                ...
                                <tbody>
                                    @forelse ($packages as $package)
                                        <tr>
                                            ...
                                            @endphp
                                            @if (  date('m/d/Y H:i:s') > $package->end)
                                            <td>{{ 'package expire' }}</td>
                                                @else
                                            <td>{{ $days }}</td>
                                            ...
                                            <td>$60</td>
                                            <td>
                                                <a href="{{ route('admin.edit.package', ['id'=>$package->id]) }}" class="btn btn-primary mar-bm" href="javascript:;">
                                                    <i class="fa fa-fw fa-edit"></i> Edit
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('admin.delete.package', ['id'=>$package->id]) }}" class=" btn btn-danger mar-bm" href="javascript:;">
